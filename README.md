...
- 우리은행 디지털전략그룹 신사업제휴플랫폼부 신사업개발팀 (2025 ~ 2025)
- 우리은행 디지털영업그룹 인증사업플랫폼부 전자문서중계사업팀 (2025 ~)
...
- 기타: CICD(Git, SVN, Jenkins, PCMS, Docker, K8S, Argo), Unity, Azure, AWS, Blockchain(DID)
...
7. 금융결제원 금융분산ID (EOS 기반 DID 서비스, 2024 ~ 2025)
8. 우리은행 자격증명 (Hyperleadger Fabric 기반 DID 서비스, 2024 ~ 2025)
